...
* ~~A simple dashboard home page showing today's packed count, returns, earnings, and urgent stock items all in one place~~
* ~~Auto-update check — compare a version number against a remote file so you know when a new build is available~~
* ~~Update pop up upon startup~~
...
* ~~Progress bar during "Mark All as Paid" — right now it just tags silently~~
